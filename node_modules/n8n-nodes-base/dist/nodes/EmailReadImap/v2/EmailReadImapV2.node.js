...
class EmailReadImapV2 {
                ...
                async imapConnectionTest(credential) {
                    if ((0, Imap_credentials_1.isCredentialsDataImap)(credential.data)) {
                        ...
                        try {
                            ...
                            const connection = await (0, imap_simple_1.connect)(config);
    ...
    async trigger() {
        ...
        const getAttachment = async (imapConnection, parts, message) => {
            ...
            const attachmentParts = parts.filter((part) => {
                ...
                return (part.disposition &&
                    ((_a = part.disposition) === null || _a === void 0 ? void 0 : _a.type).toUpperCase() === 'ATTACHMENT');
            });
            ...
            for (const attachmentPart of attachmentParts) {
                attachmentPromise = imapConnection
                    ...
                    return this.helpers.prepareBinaryData(partData, fileName);
                });
        ...
        const establishConnection = async () => {
            ...
            return (0, imap_simple_1.connect)(config).then(async (conn) => {
