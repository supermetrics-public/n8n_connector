...
async function execute(i) {
    ...
    if (Buffer.isBuffer(fileContent)) {
        const response = await transport_1.googleApiRequest.call(this, 'POST', '/upload/drive/v3/files', fileContent, {
            uploadType: 'media',
        }, undefined, {
            headers: {
        ...
        const resumableUpload = await transport_1.googleApiRequest.call(this, 'POST', '/upload/drive/v3/files', undefined, { uploadType: 'resumable' }, undefined, {
        ...
        for await (const chunk of fileContent) {
            ...
            try {
                ...
                uploadId = response === null || response === void 0 ? void 0 : response.id;
            }
            catch (error) {
