import type { IDataObject, IExecuteFunctions, ILoadOptionsFunctions, INode, INodeExecutionData, IPollFunctions } from 'n8n-workflow';
...
export declare function googleApiRequest(this: IExecuteFunctions | ILoadOptionsFunctions | IPollFunctions, method: string, endpoint: string, body?: IDataObject, qs?: IDataObject, uri?: string, option?: IDataObject): Promise<any>;
...
export declare function googleApiRequestAllItems(this: IExecuteFunctions | ILoadOptionsFunctions | IPollFunctions, propertyName: string, method: string, endpoint: string, body?: any, query?: IDataObject): Promise<any>;
...
export declare function prepareEmailAttachments(this: IExecuteFunctions, options: IDataObject, items: INodeExecutionData[], itemIndex: number): Promise<IDataObject[]>;
export declare function unescapeSnippets(items: INodeExecutionData[]): INodeExecutionData[];
export declare function replyToEmail(this: IExecuteFunctions, items: INodeExecutionData[], gmailId: string, options: IDataObject, itemIndex: number): Promise<any>;
