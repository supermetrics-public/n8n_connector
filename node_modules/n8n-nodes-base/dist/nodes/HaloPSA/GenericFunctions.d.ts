import type { ICredentialDataDecryptedObject, ICredentialTestFunctions, IDataObject, IExecuteFunctions, IHookFunctions, ILoadOptionsFunctions, IPollFunctions } from 'n8n-workflow';
...
export declare function haloPSAApiRequest(this: IHookFunctions | IExecuteFunctions | ILoadOptionsFunctions | IPollFunctions, method: string, resource: string, accessToken: string, body?: IDataObject | IDataObject[], qs?: IDataObject, option?: IDataObject): Promise<any>;
