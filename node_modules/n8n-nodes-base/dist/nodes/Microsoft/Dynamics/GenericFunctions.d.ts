import type { IExecuteFunctions, ILoadOptionsFunctions, IDataObject, INodeProperties, INodePropertyOptions } from 'n8n-workflow';
export declare function microsoftApiRequest(this: IExecuteFunctions | ILoadOptionsFunctions, method: string, resource: string, body?: any, qs?: IDataObject, uri?: string, option?: IDataObject): Promise<any>;
