import type { IDataObject, IExecuteFunctions, IExecuteSingleFunctions, ILoadOptionsFunctions } from 'n8n-workflow';
...
export declare function prepareApiError(this: IExecuteFunctions | IExecuteSingleFunctions | ILoadOptionsFunctions, error: IDataObject, itemIndex?: number): NodeApiError;
