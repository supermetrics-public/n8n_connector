...
exports.decodeOutlookId = exports.encodeOutlookId = exports.prepareApiError = exports.prepareFilterString = exports.prepareContactFields = exports.simplifyOutputMessages = exports.createMessage = exports.makeRecipient = exports.contactFields = exports.eventfields = exports.messageFields = void 0;
...
function simplifyOutputMessages(data) {
    return data.map((item) => {
        ...
        return {
            ...
            from: (_b = (_a = item.from) === null || _a === void 0 ? void 0 : _a.emailAddress) === null || _b === void 0 ? void 0 : _b.address,
            to: item.toRecipients.map((recipient) => { var _a; return (_a = recipient.emailAddress) === null || _a === void 0 ? void 0 : _a.address; }),
