...
exports.deleteOperation = exports.updateOperation = exports.insertOperation = exports.configurePool = exports.formatColumns = exports.executeQueryQueue = exports.createTableStruct = exports.copyInputItem = void 0;
...
async function insertOperation(tables, pool) {
    return executeQueryQueue(tables, ({ table, columnString, items }) => {
        return (0, utilities_1.chunk)(items, 1000).map(async (insertValues) => {
            ...
            const query = `INSERT INTO [${table}] (${formatColumns(columnString)}) VALUES ${valuesPlaceholder.join(', ')};`;
