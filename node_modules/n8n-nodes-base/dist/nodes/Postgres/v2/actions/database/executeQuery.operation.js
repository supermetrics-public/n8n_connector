...
async function execute(runQueries, items, nodeOptions, _db) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        if (typeof queryReplacement === 'string') {
            ...
            const rawReplacements = (_a = node.parameters.options) === null || _a === void 0 ? void 0 : _a.queryReplacement;
            if (rawReplacements) {
                ...
                for (const rawValue of rawValues) {
                    ...
                    if (resolvables.length) {
                        for (const resolvable of resolvables) {
                            values.push(this.evaluateExpression(`${resolvable}`, i));
                        }
                    }
                    else {
            ...
            if (Array.isArray(queryReplacement)) {
                ...
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Query Parameters must be a string of comma-separated values or an array of values', { itemIndex: i });
            }
        }
