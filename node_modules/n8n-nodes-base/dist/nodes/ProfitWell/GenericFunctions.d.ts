...
export declare function profitWellApiRequest(this: IHookFunctions | IExecuteFunctions | ILoadOptionsFunctions, method: string, resource: string, body?: any, qs?: IDataObject, uri?: string, option?: IDataObject): Promise<any>;
export type Metrics = {
    [key: string]: [{
        date: string;
        value: number | null;
