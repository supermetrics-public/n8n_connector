...
exports.validateJSON = exports.strapiApiRequestAllItems = exports.getToken = exports.strapiApiRequest = exports.removeTrailingSlash = void 0;
...
async function strapiApiRequest(method, resource, body = {}, qs = {}, uri, headers = {}) {
    ...
    const url = (0, exports.removeTrailingSlash)(credentials.url);
    try {
        const options = {
            headers: {},
            method,
