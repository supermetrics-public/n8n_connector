...
async function commentSearch(filter, paginationToken) {
    return listResource.call(this, 'listComment', 'message', 'message', undefined, filter, paginationToken);
}
...
async function logSearch(filter, paginationToken) {
    return listResource.call(this, 'listLog', 'message', 'message', undefined, filter, paginationToken);
}
