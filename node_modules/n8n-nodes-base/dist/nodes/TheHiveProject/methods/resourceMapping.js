...
exports.getObservableUpdateFields = exports.getObservableFields = exports.getLogFields = exports.getTaskUpdateFields = exports.getTaskFields = exports.getCaseUpdateFields = exports.getCaseFields = exports.getAlertUpdateFields = exports.getAlertFields = void 0;
...
async function getCustomFields() {
    ...
    return customFields.map((field) => {
        ...
        return ({
            ...
            required: false,
            display: true,
            type: ((_a = field.options) === null || _a === void 0 ? void 0 : _a.length) ? 'options' : field.type,
            defaultMatch: false,
            options: ((_b = field.options) === null || _b === void 0 ? void 0 : _b.length)
