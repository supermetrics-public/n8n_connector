import type { IDataObject, IExecuteFunctions, IHookFunctions, ILoadOptionsFunctions, INodeParameterResourceLocator } from 'n8n-workflow';
export declare function twitterApiRequest(this: IExecuteFunctions | ILoadOptionsFunctions | IHookFunctions, method: string, resource: string, body?: IDataObject, qs?: IDataObject, fullOutput?: boolean, uri?: string, option?: IDataObject): Promise<any>;
